...
```{r fig16, eval=T,echo=F, fig.cap="一个层次模型的示例",dev="png",results='markup', cache=F}
...
```{r fig20,eval=F,redsults = 'hide',echo=F,fig.cap="邻接法",dev="png",results='markup', cache=F,fig.width=5, fig.height=0.5}
...
```{r fig29,eval=T,redsults = 'hide',echo=F,fig.cap="二级映象",dev="png",results='markup', cache=F}
...
```{r fig30,eval=T,redsults = 'hide',echo=F,fig.cap="各种人员的数据视图",dev="png",results='markup', cache=F}
...
- 聚集函数的一般格式如图\@ref(fig:fig31)：
    
```{r fig31,eval=T,redsults = 'hide',echo=F,fig.cap="聚集函数的一般格式",dev="png",results='markup', cache=F}
knitr::include_graphics("./results/31.png")
```

- WHERE子句的条件表达式的可选格式如图\@ref(fig:fig32)和\@ref(fig:fig33)：

```{r fig32,eval=T,redsults = 'hide',echo=F,fig.cap="可选格式",dev="png",results='markup', cache=F}
knitr::include_graphics("./results/32.png")
```

```{r fig33,eval=T,redsults = 'hide',echo=F,fig.cap="可选格式",dev="png",results='markup', cache=F}
knitr::include_graphics("./results/33.png")
```
